	...
	function fbcomcon_options() {
		...
		echo '<tr valign="top">
				...
				<td><select name="fbcomcon_layout" size="1">
						<option value="light"'.$light_sel.'>Light Style</option>
						<option value="dark"'.$dark_sel.'>Dark Style</option>
		...
		echo '<tr valign="top">
				...
				<td><select name="fbcomcon_lang" size="1">
						<option value="en_US"'.$en_US_sel.'>English</option>
						<option value="de_DE"'.$de_DE_sel.'>Deutsch</option>
						<option value="fr_FR"'.$fr_FR_sel.'>Fran&ccedil;ais</option>
						<option value="es_ES"'.$es_ES_sel.'>Espagnol</option>
		...
		echo '<input type="hidden" name="page_options" value="fbcomcon_app_id,fbcomcon_secret,fbcomcon_admin_uid,fbcomcon_layout,fbcomcon_lang,fbcomcon_custom_token,fbcomcon_comments_limit,fbcomcon_paging_limit" />';
		?>
		<p class="submit">
